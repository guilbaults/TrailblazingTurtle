...
urlpatterns = [
    ...
    # path('<str:account>/graph/mem.json', views.graph_mem_account),
    # path('<str:account>/graph/lustre_mdt.json', views.graph_lustre_mdt_account),
    # path('<str:account>/graph/lustre_ost.json', views.graph_lustre_ost_account),
    # path('<str:account>/graph/gpu_utilization.json', views.graph_gpu_utilization_account),
